...
const Cart = () => {
  const history = useHistory()
	...
	const onClearCart = () => {
		if (window.confirm('Tem certeza de que deseja esvaziar seu carrinho?')) {
			dispatch(clearCart())
		}
	}
         ...
         { totalCount 
               ...
               <h2 className="content--title">
                ...
                <div className="cart--clear">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  								...
  								<span onClick={onClearCart}>Limpar carrinho</span>
                </div>
              </div>
          ...
          : <div className="container container--cart">
              <div className="cart cart--empty">
                <h2>Seu carrinho está vazio <i>😕</i></h2>
                <p>
                  Muito possivelmente você ainda não escolheu sua pizza.<br />
                  Para pedir uma pizza, vá para o menu.
                </p>
