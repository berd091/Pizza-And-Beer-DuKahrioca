...
export default function PizzaBlock({id, name, imageUrl, price, types, sizes, rating, onClickAddPizza, addedCount }) {
  const availableTypes = ['Fina', 'Tradicional']
  ...
  return (
      <div className="pizza-block">
        ...
        <i className="pizza-block--rating">Avaliação: <b> {rating} </b> / 5</i>
